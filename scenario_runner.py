...
class ScenarioRunner(object):
    ...
    def __init__(self, args):
        ...
        self.manager = ScenarioManager(self._args.debug, self._args.sync, self._args.timeout, self._args.rtFactor)
...
def main():
    ...
    if not arguments.scenario and not arguments.openscenario and not arguments.openscenarioDirectory and not arguments.route and not arguments.openscenario2:
